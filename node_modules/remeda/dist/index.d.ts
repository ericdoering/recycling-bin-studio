 ...
 */
type NTuple<T, N$1 extends number, Result$1 extends Array<unknown> = []> = Result$1["length"] extends N$1 ? Result$1 : NTuple<T, N$1, [...Result$1, T]>;
//#endregion
 ...
 * ].
 */
type TupleParts<T extends IterableContainer, Prefix$1 extends Array<unknown> = []> = T extends readonly [infer Head, ...infer Tail] ? TupleParts<Tail, [...Prefix$1, Head]> : Simplify<{
  /**
...
type TuplePartsWithoutRequired<T extends IterableContainer, Suffix$1 extends Array<unknown> = []> = T extends readonly [...infer Head, infer Tail] ? TuplePartsWithoutRequired<Head, [Tail, ...Suffix$1]> : (Suffix$1 extends readonly [] ? TuplePartsWithoutFixed<T> :
...
type TuplePartsWithoutFixed<T extends IterableContainer, Optional$1 extends Array<unknown> = []> = T extends readonly [(infer Head)?, ...infer Tail] ? Or<T extends readonly [] ? true : false, Array<T[number]> extends Tail ? true : false> extends true ? {
  /**
 ...
 */
type ChunkFixedTuple<T, N$1 extends number, Result$1 = []> = T extends readonly [infer Head, ...infer Rest] ? ChunkFixedTuple<Rest, N$1, Result$1 extends [...infer Previous extends Array<Array<unknown>>, infer Current extends Array<unknown>] ? Current["length"] extends N$1 ? [...Previous, Current, [Head]] : [...Previous, [...Current, Head]] : [[Head]]> : Result$1;
/**
 ...
 * full.
 */
type SuffixChunk<T extends Array<unknown>, Item$1, N$1 extends number> = T extends readonly [] ? [ValueOf<{ [K in IntRangeInclusive<1, N$1>]: NTuple<Item$1, K> }>] : ValueOf<{ [Padding in IntRange<0, N$1>]: ChunkFixedTuple<[...NTuple<Item$1, Padding>, ...T], N$1> }>;
/**
 ...
 * @category Array
 */
declare function countBy<T, K$1 extends PropertyKey>(data: ReadonlyArray<T>, categorizationFn: (value: T, index: number, data: ReadonlyArray<T>) => K$1 | undefined): BoundedPartial<Record<K$1, number>>;
/**
 * Categorize and count elements in an array using a defined callback function.
 * The callback function is applied to each element in the array to determine
 * its category and then counts how many elements fall into each category.
 ...
 * @category Array
 */
declare function countBy<T, K$1 extends PropertyKey>(categorizationFn: (value: T, index: number, data: ReadonlyArray<T>) => K$1 | undefined): (data: ReadonlyArray<T>) => BoundedPartial<Record<K$1, number>>;
//#endregion
...
type NonRefinedFilteredArray<T extends IterableContainer, IsItemIncluded extends boolean> = boolean extends IsItemIncluded ? Array<T[number]> : IsItemIncluded extends true ? Writable$1<T> : [];
/**
 ...
 * @category Array
 */
declare function flatMap<T, U$1>(data: ReadonlyArray<T>, callbackfn: (input: T, index: number, data: ReadonlyArray<T>) => ReadonlyArray<U$1> | U$1): Array<U$1>;
/**
 * Returns a new array formed by applying a given callback function to each
 * element of the array, and then flattening the result by one level. It is
 * identical to a `map` followed by a `flat` of depth 1
 ...
 * @category Array
 */
declare function flatMap<T, U$1>(callbackfn: (input: T, index: number, data: ReadonlyArray<T>) => ReadonlyArray<U$1> | U$1): (data: ReadonlyArray<T>) => Array<U$1>;
//#endregion
 ...
 * @category Array
 */
declare function groupBy<T, Key$1 extends PropertyKey = PropertyKey>(data: ReadonlyArray<T>, callbackfn: (value: T, index: number, data: ReadonlyArray<T>) => Key$1 | undefined): BoundedPartial<Record<Key$1, NonEmptyArray<T>>>;
/**
 * Groups the elements of a given iterable according to the string values
 * returned by a provided callback function. The returned object has separate
 * properties for each group, containing arrays with the elements in the group.
 ...
 * @category Array
 */
declare function groupBy<T, Key$1 extends PropertyKey = PropertyKey>(callbackfn: (value: T, index: number, data: ReadonlyArray<T>) => Key$1 | undefined): (items: ReadonlyArray<T>) => BoundedPartial<Record<Key$1, NonEmptyArray<T>>>;
//#endregion
...
type OptionalTupleRequiredPrefix<T extends Array<unknown>, N$1, Prefix$1 extends Array<unknown> = []> = Prefix$1["length"] extends N$1 ? [...Prefix$1, ...Partial<T>] : T extends readonly [infer Head, ...infer Rest] ? OptionalTupleRequiredPrefix<Rest, N$1, [...Prefix$1, Head]> : Prefix$1;
//#endregion
 ...
 * @category Array
 */
declare function indexBy<T, K$1 extends PropertyKey>(data: ReadonlyArray<T>, mapper: (item: T, index: number, data: ReadonlyArray<T>) => K$1): BoundedPartial<Record<K$1, T>>;
/**
 * Converts a list of objects into an object indexing the objects by the given
 * key.
 *
 ...
 * @category Array
 */
declare function indexBy<T, K$1 extends PropertyKey>(mapper: (item: T, index: number, data: ReadonlyArray<T>) => K$1): (data: ReadonlyArray<T>) => BoundedPartial<Record<K$1, T>>;
//#endregion
 ...
 * @category Array
 */
declare function mapToObj<T, K$1 extends PropertyKey, V$1>(array: ReadonlyArray<T>, fn: (value: T, index: number, data: ReadonlyArray<T>) => [K$1, V$1]): Record<K$1, V$1>;
/**
 * Map each element of an array into an object using a defined mapper that
 * converts each item into an object entry (a tuple of `[<key>, <value>]`).
 *
 ...
 * @category Array
 */
declare function mapToObj<T, K$1 extends PropertyKey, V$1>(fn: (value: T, index: number, data: ReadonlyArray<T>) => [K$1, V$1]): (array: ReadonlyArray<T>) => Record<K$1, V$1>;
//#endregion
...
type OmitFromArray<T, Keys$1 extends ReadonlyArray<PropertyKey>> = T extends unknown ? Keys$1 extends unknown ? SimplifiedWritable<IsNever<Extract<Keys$1[number], keyof T>> extends true ? T : IsBoundedRecord<T> extends true ? OmitBounded<T, Keys$1> : OmitUnbounded<T, Keys$1>> : never : never;
type OmitBounded<T, Keys$1 extends ReadonlyArray<PropertyKey>> = FixEmpty<Omit<T, Keys$1[number]>> & Partial<Pick<T, Exclude<PartitionByUnion<TupleParts<Keys$1>["required"]>["union"] | TupleParts<Keys$1>["optional"][number] | TupleParts<Keys$1>["item"] | PartitionByUnion<TupleParts<Keys$1>["suffix"]>["union"], PartitionByUnion<TupleParts<Keys$1>["required"]>["singular"] | PartitionByUnion<TupleParts<Keys$1>["suffix"]>["singular"]>>>;
/**
 ...
 */
type OmitUnbounded<T, Keys$1 extends ReadonlyArray<PropertyKey>> = T & Record<Bounded<PartitionByUnion<TupleParts<Keys$1>["required"]>["singular"] | PartitionByUnion<TupleParts<Keys$1>["suffix"]>["singular"]>, never>;
/**
 ...
 * @category Object
 */
declare function omit<T, const Keys$1 extends ReadonlyArray<KeysOfUnion<T>>>(keys: Keys$1): (data: T) => OmitFromArray<T, Keys$1>;
/**
 * Returns a partial copy of an object omitting the keys specified.
 *
 ...
 * @category Object
 */
declare function omit<T, const Keys$1 extends ReadonlyArray<KeysOfUnion<T>>>(data: T, keys: Keys$1): OmitFromArray<T, Keys$1>;
//#endregion
...
type PickFromArray<T, Keys$1 extends ReadonlyArray<KeysOfUnion<T>>> = T extends unknown ? Keys$1 extends unknown ? IsNever<Extract<Keys$1[number], keyof T>> extends true ? EmptyObject : Writable$1<IsBoundedRecord<T> extends true ? PickBoundedFromArray<T, Keys$1> : PickUnbounded<T, Extract<Keys$1[number], keyof T>>> : never : never;
/**
 ...
 * @category Object
 */
declare function pick<T extends object, const Keys$1 extends ReadonlyArray<KeysOfUnion<T>>>(keys: Keys$1): (data: T) => PickFromArray<T, Keys$1>;
/**
 * Creates an object composed of the picked `data` properties.
 *
 * @param data - The target object.
 ...
 * @category Object
 */
declare function pick<T extends object, const Keys$1 extends ReadonlyArray<KeysOfUnion<T>>>(data: T, keys: Keys$1): PickFromArray<T, Keys$1>;
//#endregion
...
T[number] | undefined;
type HasIndex<T extends ReadonlyArray<unknown>, I$1> = I$1 extends ArrayIndices<T> ? true : false;
//#endregion
//#region src/prop.d.ts
type KeysDeep<T, Path$1 extends ReadonlyArray<unknown>> = KeysOfUnion<PropDeep<T, Path$1>>;
type PropDeep<T, Path$1 extends ReadonlyArray<unknown>> = Path$1 extends readonly [infer Key, ...infer Rest] ? PropDeep<Prop<T, Key>, Rest> : T;
...
type LazyEvaluator<T = unknown, R$1 = T> = (item: T, index: number, data: ReadonlyArray<T>) => LazyResult<R$1>;
//#endregion
 ...
 * @category Array
 */
declare function reduce<T, U$1>(data: ReadonlyArray<T>, callbackfn: (previousValue: U$1, currentValue: T, currentIndex: number, data: ReadonlyArray<T>) => U$1, initialValue: U$1): U$1;
/**
 * Executes a user-supplied "reducer" callback function on each element of the
 * array, in order, passing in the return value from the calculation on the
 * preceding element. The final result of running the reducer across all
 ...
 * @category Array
 */
declare function reduce<T, U$1>(callbackfn: (previousValue: U$1, currentValue: T, currentIndex: number, data: ReadonlyArray<T>) => U$1, initialValue: U$1): (data: ReadonlyArray<T>) => U$1;
//#endregion
//#region src/reverse.d.ts
type Reverse<T extends ReadonlyArray<unknown>, R$1 extends ReadonlyArray<unknown> = []> = ReturnType<T extends IsNoTuple<T> ? () => [...T, ...R$1] : T extends readonly [infer F, ...infer L] ? () => Reverse<L, [F, ...R$1]> : () => R$1>;
...
type IsLongerThan$1<T extends ReadonlyArray<unknown>, N$1 extends number> = IsEqual$1<T[N$1], undefined> extends true ? false : true;
...
type Paths<T, Prefix$1 extends ReadonlyArray<unknown> = []> = Prefix$1 | (T extends object ? ValueOf<{ [K in ProperKeyOf<T>]-?: Paths<T[K], [...Prefix$1, K]> }> : RemedaTypeError<"setPath", "Can only compute paths objects", {
  type: never;
  metadata: T;
...
type SumBy<T extends IterableContainer, U$1 extends bigint | number> = T extends readonly [] ? 0 : T extends readonly [unknown, ...ReadonlyArray<unknown>] ? U$1 : U$1 | 0;
/**
...
type TimesArray<T, N$1 extends number, Iteration extends ReadonlyArray<unknown> = []> = number extends N$1 ? Array<T> : `${N$1}` extends `-${number}` ? [] : `${N$1}` extends `${infer K extends number}.${number}` ? TimesArray<T, K, Iteration> : GreaterThan<N$1, MAX_LITERAL_SIZE> extends true ? [...TimesArray<T, MAX_LITERAL_SIZE, Iteration>, ...Array<T>] : N$1 extends Iteration["length"] ? [] : [T, ...TimesArray<T, N$1, [unknown, ...Iteration]>];
/**
