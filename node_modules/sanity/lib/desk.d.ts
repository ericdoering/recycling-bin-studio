...
/** @internal */
declare interface DocumentPaneContextValue extends Pick<NodeChronologyProps, 'hasUpstreamVersion'> {
 ...
 * @public
 */
declare abstract class GenericListBuilder_2<
  TList extends BuildableGenericList_2,
  ConcreteImpl,
 ...
 * @public
 */
declare abstract class GenericViewBuilder_2<
  TView extends Partial<BaseView_2>,
  ConcreteImpl,
...
declare const structureLocaleStrings: {
  ...
  /** Message prompting the user to confirm discarding changes */
  'action.discard-changes.confirm-dialog.confirm-discard-changes-draft': string
  /**Header for the confirm discard dialog */
  'action.discard-changes.confirm-dialog.header.text': string
   ...
   * */
  'banners.release.navigate-to-edit-description-none': string
