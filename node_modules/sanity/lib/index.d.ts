...
import {SingleDocReleaseContextValue} from 'sanity/_singletons'
 ...
 * @beta
 */
export declare type AssetSourcesResolver<S extends SchemaType = SchemaType> = (
  type: S,
  file?: FileLike,
) => AssetSource[]
 ...
 * @hidden
 * @beta */
declare interface BaseImageInputProps extends ObjectInputProps<
  BaseImageInputValue,
  ImageSchemaType
> {
  assetSources: AssetSource[]
 ...
 * @internal
 */
export declare const createAuthStore: typeof _createAuthStore
 ...
 * @hidden
 * @beta */
export declare interface DefaultPreviewProps extends Omit<
 ...
 * @hidden
 * @beta */
export declare interface DocumentActionComponent extends ActionComponent<
  DocumentActionProps,
 ...
 * @beta
 */
export declare interface DocumentActionDescription extends GroupableActionDescription<DocumentActionGroup> {
 ...
 * @hidden
 * @beta */
export declare interface DocumentBadgeComponent extends HookCollectionActionHook<
  DocumentBadgeProps,
...
declare interface DocumentFormValue extends Pick<NodeChronologyProps, 'hasUpstreamVersion'> {
  /**
 ...
 * @hidden
 * @beta */
export declare interface DocumentStackAvailability {
  /**
   * Document id
   */
  id: string
 ...
 * @alpha
 */
export declare interface FormBuilderProps extends Omit<
  ObjectFormNode,
  | 'level'
  | 'path'
  | 'presence'
 ...
 * @internal
 */
export declare function getDocumentIdForCanvasLink(
...
/** @internal */
export declare function GetHookCollectionState<Args, State>(
 ...
 * @beta
 */
export declare interface GroupableActionDescription<
  GroupType = unknown,
 ...
 * @hidden
 * @beta */
export declare interface InputOnSelectFileFunctionProps {
 ...
 * @beta
 */
export declare type MarkdownConfig = Omit<
 ...
 * @public
 */
export declare interface NodeChronologyProps {
  /**
 ...
 * @public
 */
export declare interface NodeDiffProps<Annotation, Value = unknown> extends NodeChronologyProps {
  /**
 ...
 * @public
 */
export declare interface ObjectItemProps<
 ...
 * @public
 * */
export declare interface PortableTextInputProps extends ArrayOfObjectsInputProps<
  PortableTextBlock,
...
declare interface PreviewHookOptions {
  documentId: string
  documentType: string
  perspectiveStack: string[]
}

declare interface PreviewHookValue {
  isLoading: boolean
 ...
 * @hidden
 * @beta */
export declare type ProjectGrants = Record<
  string,
  | {
      id: string
      name: string
...
/** @internal */
export declare const ReleaseAvatarIcon: ({tone}: {tone: BadgeTone}) => JSX.Element
...
/** @internal */
export declare interface ScrollContainerProps<T extends ElementType> extends Omit<
  HTMLProps<T>,
  'as' | 'onScroll'
> {
  as?: ElementType | keyof React.JSX.IntrinsicElements
 ...
 * @alpha
 */
export declare interface SearchOperatorBuilder<
  TType extends string,
  TValue,
 ...
 * @internal
 */
export declare function selectUpstreamVersion(
  upstreamEditState: EditStateFor,
): SanityDocument_2 | null
 ...
 * @internal
 */
export declare function SingleDocReleaseProvider({
  children,
  onSetScheduledDraftPerspective,
}: SingleDocReleaseProviderProps): JSX.Element

declare interface SingleDocReleaseProviderProps {
  children: React.ReactNode
 ...
 * @internal
 */
export declare function sortReleases(releases?: ReleaseDocument[]): ReleaseDocument[]
...
declare const studioLocaleStrings: {
  ...
  'asset-source.dialog.default-title_video': string
  /** Insert asset error */
  ...
  'asset-sources.media-library.select-dialog.title_video': string
 ...
 * @deprecated – Will be removed in upcoming major version
 * */
export declare interface StudioTheme extends Omit<
  RootTheme,
  | 'avatar'
  | 'button'
  | 'container'
 ...
 */
export declare type StudioThemeColorSchemeKey = StudioColorScheme
...
/** @internal */
export declare function useDocumentPreviewValues(options: PreviewHookOptions): PreviewHookValue
 ...
 * @internal
 */
export declare function useEnhancedObjectDialog(): EnhancedObjectDialogContextValue
...
/** @internal */
export declare interface UseFormStateOptions extends Pick<
  NodeChronologyProps,
  'hasUpstreamVersion'
> {
  schemaType: ObjectSchemaType
 ...
 */
export declare function useGetDefaultPerspective(): 'drafts' | 'published'
 ...
 */
export declare function useScheduledDraftsEnabled(): boolean
 ...
 * @internal
 */
export declare function useSingleDocRelease(): SingleDocReleaseContextValue
 ...
 * @alpha
 */
export declare interface ValuelessSearchOperatorBuilder<
  TType extends string,
> extends SearchOperatorBase {
