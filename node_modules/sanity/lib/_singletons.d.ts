 ...
 * @beta
 */
export declare const DialogStackContext: Context<DialogStackContextValue | null>
 ...
 * @beta
 */
export declare interface DialogStackContextValue {
 ...
 * @beta
 */
export declare interface DialogStackEntry {
  id: string
  path?: Path
}
